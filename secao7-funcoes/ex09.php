<?php
    ...
    function exibe($cargos) {
        ...
        foreach ($cargos as $cargo) {
            ...
            if ( isset($cargo['subordinados']) && count($cargo['subordinados'])>0 ){    //verifica se tem subordinados
                $html .= exibe($cargo['subordinados']); //chamada recursiva da função
            }

            $html .= "</li>";
        }

        $html .= "</ul>"; //comando ".=" para concatenar
